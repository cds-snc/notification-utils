...
from notifications_utils.authentication.bearer_auth import BearerAuth
...
class ZenDeskSellClient(object):
    ...
    def __init__(self, app: Flask, contact: ContactRequest):
        self.app = app
        self.api_url = app.config['ZEN_DESK_BASE_URL']
        self.token = app.config['ZEN_DESK_BASE_API_KEY']
