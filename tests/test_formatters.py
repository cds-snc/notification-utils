...
def test_makes_links_out_of_URLs(url):
    link = '<a style="word-wrap: break-word; word-break: break-all;" href="{}">{}</a>'.format(url, url)
    ...
    [
        (
            ...
            (
                ...
                '<a style="word-wrap: break-word; word-break: break-all;" href="http://example.com">http://example.com</a>'
                " in the middle"
            ),
        ),
        (
...
def test_handles_placeholders_in_urls():
    assert notify_email_markdown("http://example.com/?token=<span class='placeholder'>((token))</span>&key=1") == (
        ...
        '<a style="word-wrap: break-word; word-break: break-all;" href="http://example.com/?token=">'
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            """<a style="word-wrap: break-word; word-break: break-all;" href="https://example.com%22onclick=%22alert%28%27hi">https://example.com"onclick="alert('hi</a>')""",  # noqa
            """<a style="word-wrap: break-word; word-break: break-all;" href="https://example.com%22onclick=%22alert%28%27hi">https://example.com"onclick="alert('hi</a>‘)""",  # noqa
        ),
        (
            """https://example.com"style='text-decoration:blink'""",
            """<a style="word-wrap: break-word; word-break: break-all;" href="https://example.com%22style=%27text-decoration:blink">https://example.com"style='text-decoration:blink</a>'""",  # noqa
            """<a style="word-wrap: break-word; word-break: break-all;" href="https://example.com%22style=%27text-decoration:blink">https://example.com"style='text-decoration:blink</a>’""",  # noqa
        ),
    ],
)
...
def test_HTML_template_has_URLs_replaced_with_links():
    assert (
        '<a style="word-wrap: break-word; word-break: break-all;" href="https://service.example.com/accept_invite/a1b2c3d4">'
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            (
                '<p style="Margin: 0 0 20px 0; font-size: 19px; line-height: 25px; color: #0B0C0C;">'
                '<a style="word-wrap: break-word; word-break: break-all;" href="https://example.com">'
                "https://example.com"
                "</a>"
                "</p>"
                '<p style="Margin: 0 0 20px 0; font-size: 19px; line-height: 25px; color: #0B0C0C;">'
...
@pytest.mark.parametrize(
    ...
    (
        ...
        [
            ...
            (
                '<p style="Margin: 0 0 20px 0; font-size: 19px; line-height: 25px; color: #0B0C0C;">'
                '<a style="word-wrap: break-word; word-break: break-all;" href="https://example.com%22onclick=%22alert%28%27hi">'
                'https://example.com"onclick="alert(\'hi'
                "</a>')"
                "</p>"
            ),
    ...
    (
        ...
        [
            ...
            (
                ...
                'color: #0B0C0C;">'
                '<a style="word-wrap: break-word; word-break: break-all;" href="http://example.com">Example</a>'
                "</p>"
            ),
        ],
        [
    ...
    (
        ...
        [
            ...
            (
                '<p style="Margin: 0 0 20px 0; font-size: 19px; line-height: 25px; '
                'color: #0B0C0C;">'
                '<a style="word-wrap: break-word; word-break: break-all;" href="http://example.com" title="An example URL">'
                "Example"
                "</a>"
                "</p>"
            ),
